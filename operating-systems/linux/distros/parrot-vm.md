...
```bash
sudo apt install -y apt-transport-https btop chrony curl duf flameshot htop neofetch neofetch net-tools pipx speedtest-cli telegram-desktop terminator tor tree vlc wget
```
