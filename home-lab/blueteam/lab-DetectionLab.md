...
* Host can be brought up one at a time using this command (or proceed with the [Parallel Provisioning](https://github.com/syselement/blog/blob/main/home-lab/blueteam/lab_DetectionLab.md#parallel-provisioning-hosts)):
...
> * If you encounter an error or any issues, checkout the [troubleshooting section](https://github.com/syselement/blog/blob/main/home-lab/blueteam/lab_DetectionLab.md#troubleshooting-and-known-issues).
