...
- Host can be brought up one at a time using this command (or proceed with the [Parallel Provisioning](#parallel-provisioning-hosts)):
...
![post_build_checks.ps1 error](.gitbook/assets/image-20230202134518758.png)
